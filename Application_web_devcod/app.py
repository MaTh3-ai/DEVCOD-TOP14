...
@app.route('/prono')
def prono():
    return render_template('prono.html')  # Modifié pour pointer vers la bonne page d'accueil

@app.route('/equipe')
def equipe():
    return render_template('equipes.html')  # Modifié pour pointer vers la bonne page d'accueil

@app.route('/construction')
def construction():
    return render_template('construction.html')  # Modifié pour pointer vers la bonne page d'accueil

@app.route('/DroitAcces')
def DroitAcces():
    return render_template('GererDroitDacces.html')  # Modifié pour pointer vers la bonne page d'accueil

@app.route('/stats')
def public_stats():
    # Logique pour afficher les statistiques publiques
    return render_template('GererDroitTelePub.html')


@app.route('/public_stats', endpoint='stats_view')
